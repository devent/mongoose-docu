\TheCommand{exec}%
\Command{exec [handler: handler] [destroyer: destroyer]\\~
[watchdog: watchdog] [timeout: duration]\\~
[successExitValue: number] [successExitValues: list]\\~
command [env: map] [directory: path]}
...
The working directory of the process can be set by \Arg{directory}. The default value
